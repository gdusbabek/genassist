...
function populateCandidates(songs, callback) {
    ...
    songs.forEach(function(song) {
        $('#candidate-table tbody').append('<tr><td><a class="btn btn-mini" id="candidate_' + song.id + '" href="/seed.html?songId=' + song.id +'&sinceYear=' + sinceYear + '&songName=' + song.title + '"><i class="icon-headphones"/> yes!</a></td><td>' + song.artist + '</td><td>' + song.title + '</td></tr>');
    });
    callback(null);
}
